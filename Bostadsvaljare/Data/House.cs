            ...
            if (!houseData.ContainsKey(project))
            {
                if (project == "WIJK") {
                    ...
                    houseData.Add(project, new List<House> {
                        ...
                        new House { ID = id++, Address = "Räkvägen 11", Sqm = "-", LandArea="309 m²", Price = "-", Rent = "-", HouseNumber = "142", Status = "available", Housetype="120 typ 1", HouseFact="BOFAKTABLAD_Hus 120_TYP 1.pdf" },
                        new House { ID = id++, Address = "Räkvägen 12", Sqm = "-", LandArea="316 m²", Price = "-", Rent = "-", HouseNumber = "135", Status = "available", Housetype="120 typ 1 SP", HouseFact="BOFAKTABLAD_Hus 120_TYP 1-SP.pdf" },
                        new House { ID = id++, Address = "Räkvägen 13", Sqm = "120,5 m²", LandArea="356 m²", Price = "5 650 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "141", Status = "showcase", Housetype="120 typ 2", HouseFact="BOFAKTABLAD_Hus 120_TYP 2.pdf" },
                        new House { ID = id++, Address = "Räkvägen 14", Sqm = "-", LandArea="314 m²", Price = "-", Rent = "-", HouseNumber = "134", Status = "available", Housetype="120 typ 1 SP", HouseFact="BOFAKTABLAD_Hus 120_TYP 1-SP.pdf" },
                        new House { ID = id++, Address = "Räkvägen 16", Sqm = "120,5 m²", LandArea="360 m²", Price = "5 650 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "133", Status = "showcase", Housetype="120 typ 2 SP", HouseFact="BOFAKTABLAD_Hus 120_TYP 2-SP.pdf" },
                    });
                }
            }

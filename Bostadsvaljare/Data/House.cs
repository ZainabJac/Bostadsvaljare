        ...
        public static List<House> GetHouseData()
        {
            if (houseData == null) {
                ...
                houseData = new List<House> {
                    new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "", Rent = "5 450 kr/mån", Propertytyp = "Bostadsrätt", HouseNumber = "1", Status = "booked", Housetype="G3K-red" , HouseFact="Brf1Husnr1.pdf" },
                   ...
                   new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "", Rent = "5 450 kr/mån", Propertytyp = "Bostadsrätt", HouseNumber = "10", Status = "booked", Housetype="G3K-grey" , HouseFact="Brf1Husnr10.pdf" },
                    ...
                    new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "", Rent = "5 450 kr/mån", Propertytyp = "Bostadsrätt", HouseNumber = "14", Status = "booked", Housetype="G3K-red" , HouseFact="Brf1Husnr14.pdf" },
                   ...
                   new House { ID = id++, Sqm = "148 m²", LandArea="309 m²", Price = "-", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "17", Status = "sold", Housetype="G3K-grey" , HouseFact="Ag3Husnr17.pdf" },
                    ...
                    new House { ID = id++, Sqm = "148 m²", LandArea="362 m²", Price = "-", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "23", Status = "sold", Housetype="G3K-grey" , HouseFact="Ag3Husnr23.pdf" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "24", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "25", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "26", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "27", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "28", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "29", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "30", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "31", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "32", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "33", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "34", Status = "available", Housetype="G3K-grey" , HouseFact="" },
                     new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "35", Status = "available", Housetype="G3K-grey" , HouseFact="" },
                     new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "36", Status = "available", Housetype="G3K-grey" , HouseFact="" },
                    new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "37", Status = "available", Housetype="G3K-grey" , HouseFact="" },
                    new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "38", Status = "available", Housetype="G2" , HouseFact="" },
                    new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "39", Status = "available", Housetype="G2" , HouseFact="" },
                    new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "40", Status = "available", Housetype="G2" , HouseFact="" },
                   new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "41", Status = "available", Housetype="G2" , HouseFact="" },
                    new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "42", Status = "available", Housetype="G2" , HouseFact="" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "43", Status = "available", Housetype="G2" , HouseFact="" },
                   ...
                   new House { ID = id++, Sqm ="150 m²", LandArea="380 m²", Price = "-", Rent = "-", Propertytyp = "Äganderätt",  HouseNumber = "50", Status = "sold", Housetype="V2-grey" , HouseFact="Ag1Husnr50.pdf" },
                    new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "51", Status = "available", Housetype="V2-green" , HouseFact="Ag1Husnr51.pdf" },
                     new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "52", Status = "available", Housetype="V2-green" , HouseFact="Ag1Husnr52.pdf" },
                   ...
                   new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "57", Status = "available", Housetype="G3K-top-red" , HouseFact="" },
                    ...
                    new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "61", Status = "available", Housetype="G3K-top-grey" , HouseFact="" },
                   ...
                   new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "64", Status = "available", Housetype="G3K-top-grey" , HouseFact="" },
                    ...
                    new House { ID = id++, Sqm = "148 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "70", Status = "available", Housetype="G3K-top-grey" , HouseFact="" },

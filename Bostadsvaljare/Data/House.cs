        ...
        public static List<House> GetHouseData()
        {
            if (houseData == null)
            {
                ...
                houseData = new List<House> {
                    ...
                    new House { ID = id++, Sqm = "150 m²", LandArea="387 m²", Price = "7 930 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "52", Status = "available", Housetype="V2-green", HouseFact="Ag1Husnr52.pdf" },
                    ...
                    new House { ID = id++, Sqm = "148 m²", LandArea="196 m²", Price = "-", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "68", Status = "sold", Housetype="G3K-top-grey", HouseFact="ag2_68.pdf" },

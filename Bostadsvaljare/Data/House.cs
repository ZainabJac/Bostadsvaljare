                ...
                houseData = new List<House> {
                   ...
                   new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "41", Status = "comming", Housetype="G2" , HouseFact="" },
                    ...
                    new House { ID = id++, Sqm ="150 m²", LandArea="-", Price = "-", Rent = "-", HouseNumber = "45", Propertytyp = "Äganderätt", Status = "showcase", Housetype="V2-grey" , HouseFact="Ag1Husnr45.pdf" },
                     new House { ID = id++, Sqm ="150 m²", LandArea="570 m²", Price = "6 750 000 kr ", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "46", Status = "booked", Housetype="V2-grey" , HouseFact="Ag1Husnr46.pdf" },
                    new House { ID = id++, Sqm ="150 m²", LandArea="445 m²", Price = "6 950 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "47", Status = "booked", Housetype="V2-red" , HouseFact="Ag1Husnr47.pdf" },
                    new House { ID = id++, Sqm ="150 m²", LandArea="381 m²", Price = "6 500 000 kr", Rent = "-",  Propertytyp = "Äganderätt", HouseNumber = "48", Status = "booked", Housetype="V2-grey" , HouseFact="Ag1Husnr48.pdf" },
                    new House { ID = id++, Sqm ="150 m²", LandArea="439 m²", Price = "6 950 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "49", Status = "booked", Housetype="V2-red" , HouseFact="Ag1Husnr49.pdf" },

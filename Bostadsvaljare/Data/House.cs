        ...
        public static List<House> GetHouseData()
        {
            if (houseData == null) {
                ...
                houseData = new List<House> {
                   ...
                   new House { ID = id++, Sqm = "148 m²", LandArea="309 m²", Price = "5 650 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "17", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr17.pdf" },
                    new House { ID = id++, Sqm = "148 m²", LandArea="350 m²", Price = "5 750 000 kr", Rent = "-", Propertytyp = "Äganderätt",  HouseNumber = "18", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr18.pdf" },
                     new House { ID = id++, Sqm = "148 m²", LandArea="553 m²", Price = "5 995 000 kr", Rent = "-",Propertytyp = "Äganderätt", HouseNumber = "19", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr19.pdf" },
                    new House { ID = id++, Sqm = "148 m²", LandArea="313 m²", Price = "5 550 000 kr", Rent = "-",  Propertytyp = "Äganderätt", HouseNumber = "20", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr20.pdf" },
                    new House { ID = id++, Sqm = "148 m²", LandArea="239 m²", Price = "5 375 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "21", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr21.pdf" },
                     new House { ID = id++, Sqm = "148 m²", LandArea="308 m²", Price = "5 475 000 kr", Rent = "-", Propertytyp = "Äganderätt",  HouseNumber = "22", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr22.pdf" },
                    new House { ID = id++, Sqm = "148 m²", LandArea="362 m²", Price = "5 695 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "23", Status = "booked", Housetype="G3K-grey" , HouseFact="Ag3Husnr23.pdf" },
                   ...
                   new House { ID = id++, Sqm = "-", LandArea="-", Price = "-", Rent = "-", HouseNumber = "41", Status = "comming", Housetype="G2" , HouseFact="" },
                    ...
                    new House { ID = id++, Sqm ="150 m²", LandArea="606 m²", Price = "7 050 000 kr", Rent = "-", Propertytyp = "Äganderätt", HouseNumber = "44", Status = "booked", Housetype="V2-red" , HouseFact="Ag1Husnr44.pdf" },
                   ...
                   new House { ID = id++, Sqm ="150 m²", LandArea="380 m²", Price = "6 550 000 kr", Rent = "-", Propertytyp = "Äganderätt",  HouseNumber = "50", Status = "booked", Housetype="V2-grey" , HouseFact="Ag1Husnr50.pdf" },
